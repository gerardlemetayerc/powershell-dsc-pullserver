...
func AgentByIdAPIHandler(w http.ResponseWriter, r *http.Request) {
	...
	defer database.Close()
	       ...
	       var state *string
	       err = row.Scan(&a.AgentId, &internalDSCId, &a.NodeName, &a.LCMVersion, &a.RegistrationType, &a.CertificateThumbprint, &a.CertificateSubject, &a.CertificateIssuer, &a.CertificateNotBefore, &a.CertificateNotAfter, &a.RegisteredAt, &a.LastCommunication, &hasErrorBool, &state)
